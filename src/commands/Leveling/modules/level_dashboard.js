...
function buildDashboardEmbed(cfg, guild) {
    ...
    return new EmbedBuilder()
        ...
        .setDescription(
            `Управление настройками системы уровней для **${guild.name}**.\n` +
            `Выберите нужный параметр ниже, чтобы изменить его.`
        )
        .setColor(getColor('info'))
        .addFields(
            {
                name: 'Канал повышения уровня',
                value: channel,
                inline: true
            },
            {
            ...
            {
                name: 'Сообщение при повышении уровня',
                value: msgPreview,
                inline: false
            },
            {
            ...
            },
            {
                ...
                value: ignoredChValue,
                inline: true
            },
            {
                name: 'Игнорируемые роли',
                value: ignoredRoValue,
                inline: true
            }
        )
        .setFooter({
            text: 'Панель управления закроется после 10 минут бездействия'
        })
        .setTimestamp();
}
    ...
    return new StringSelectMenuBuilder()
        ...
        .addOptions(
            ...
            new StringSelectMenuOptionBuilder()
                ...
                .setDescription(
                    'Выберите канал для отправки уведомлений о повышении уровня'
                )
                .setValue('channel')
                .setEmoji('📢'),
            ...
            new StringSelectMenuOptionBuilder()
                ...
                .setDescription(
                    'Настройте сообщение, которое отображается при повышении уровня'
                )
                .setValue('message')
                .setEmoji('💬'),
            ...
            new StringSelectMenuOptionBuilder()
                ...
                .setDescription(
                    'Установите минимальное и максимальное количество XP за сообщение'
                )
                .setValue('xp_range')
                .setEmoji('🎲'),
            ...
            new StringSelectMenuOptionBuilder()
                ...
                .setDescription(
                    'Количество секунд между начислениями XP одному пользователю'
                )
            ...
            new StringSelectMenuOptionBuilder()
                ...
                .setDescription(
                    'Выдать роль пользователю при достижении определённого уровня'
                )
            ...
            new StringSelectMenuOptionBuilder()
                ...
                .setDescription(
                    'Удалить награду за определённый уровень'
                )
            ...
            new StringSelectMenuOptionBuilder()
                ...
                .setDescription(
                    'Переключить каналы, в которых XP не начисляется'
                )
            ...
            new StringSelectMenuOptionBuilder()
                ...
                .setDescription(
                    'Переключить роли, пользователи с которыми не получают XP'
                )
...
function buildButtonRow(cfg, guildId, disabled = false) {
    ...
    return new ActionRowBuilder().addComponents(
        ...
        new ButtonBuilder()
            .setCustomId(
                `level_cfg_toggle_system_${guildId}`
            )
...
export default {
    ...
    async execute(interaction, config, client) {
        try {
            ...
            /*
             * ВАЖНО:
             * Проверку cfg.configured убираем.
             *
             * В текущей системе getLevelingConfig()
             * не обязан возвращать configured.
             */
                            ...
                            await btnInteraction.followUp({
                                embeds: [
                                    successEmbed(
                                        ...
                                        `Уведомления о повышении уровня теперь **${
                                            cfg.announceLevelUp
                                                ? 'включены'
                                                : 'выключены'
                                        }**.`
...
async function handleRoleRewardAdd(
    ...
    const modal = new ModalBuilder()
        .setCustomId(
            `level_cfg_role_reward_add_${guildId}`
        )
        .setTitle(
    ...
    const roleLabel =
        new LabelBuilder()
            ...
            .setDescription(
                'Эта роль будет выдана при достижении указанного уровня'
            )
    ...
    if (
        ...
        await replyUserError(
            submitted,
            {
                ...
                message:
                    'Уровень должен быть целым числом от **1** до **500**.'
            }
        );
...
async function handleRoleRewardRemove(
    ...
    if (entries.length === 0) {
        ...
        await replyUserError(
            selectInteraction,
            {
                ...
                message:
                    'Нет настроенных наград за уровни, которые можно удалить.'
            }
        );
    ...
    const modal =
        new ModalBuilder()
            .setCustomId(
                `level_cfg_role_reward_remove_${guildId}`
            )
            .setTitle(
                '🗑️ Удалить награду за уровень'
            );
    ...
    const infoInput =
        new TextInputBuilder()
            ...
            .setLabel(
                'Текущие награды (только для чтения)'
            )
            .setStyle(
    ...
    const levelInput =
        new TextInputBuilder()
            ...
            .setLabel(
                'Уровень, награду которого нужно удалить'
            )
            .setStyle(
                TextInputStyle.Short
            )
        ...
        await replyUserError(
            submitted,
            {
                type:
                    ErrorTypes.USER_INPUT,
                message:
                    `Для уровня **${rawLevel}** награда не настроена.`
            }
        );
...
async function handleChannel(
    ...
    const modal =
        new ModalBuilder()
            .setCustomId(
                `level_cfg_channel_modal_${guildId}`
            )
            .setTitle(
                '📢 Изменить канал повышения уровня'
            );
    ...
    const channelLabel =
        new LabelBuilder()
            ...
            .setDescription(
                'Канал, куда будут отправляться уведомления о повышении уровня'
            )
    ...
    const channel =
        selectInteraction.guild.channels.cache
            .get(channelId);
    ...
    if (
        ...
        await replyUserError(
            submitted,
            {
                ...
                message:
                    `Мне нужны разрешения **SendMessages** и **EmbedLinks** в ${channel}, чтобы отправлять уведомления о повышении уровня.`
            }
        );
    ...
    await submitted.reply({
        embeds: [
            successEmbed(
                '✅ Канал обновлён',
                `Уведомления о повышении уровня теперь будут отправляться в ${
                    channel ??
                    `<#${channelId}>`
                }.`
            )
...
async function handleIgnoreChannels(
    ...
    const modal =
        new ModalBuilder()
            .setCustomId(
                `level_cfg_ignore_channels_${guildId}`
            )
            .setTitle(
                '🚫 Игнорируемые каналы'
            );
    ...
    const channelSelect =
        new ChannelSelectMenuBuilder()
            ...
            .setPlaceholder(
                'Выберите каналы для переключения...'
            )
            .setMinValues(1)
            .setMaxValues(10)
            .addChannelTypes(
    ...
    const channelLabel =
        new LabelBuilder()
            .setLabel(
                'Переключить игнорируемые каналы'
            )
            .setDescription(
                'Выбранные каналы будут переключены — в них XP начисляться не будет'
            )
            .setChannelSelectMenuComponent(
                channelSelect
            );
...
async function handleIgnoreRoles(
    ...
    const modal =
        new ModalBuilder()
            .setCustomId(
                `level_cfg_ignore_roles_${guildId}`
            )
            .setTitle(
                '🚫 Игнорируемые роли'
            );
    ...
    const roleSelect =
        new RoleSelectMenuBuilder()
            ...
            .setPlaceholder(
                'Выберите роли для переключения...'
            )
            .setMinValues(1)
            .setMaxValues(10)
            .setRequired(true);
    ...
    const roleLabel =
        new LabelBuilder()
            .setLabel(
                'Переключить игнорируемые роли'
            )
            .setDescription(
                'Выбранные роли будут переключены — пользователи с ними не будут получать XP'
            )
            .setRoleSelectMenuComponent(
                roleSelect
            );
...
async function handleMessage(
    ...
    const modal =
        new ModalBuilder()
            ...
            .setTitle(
                '💬 Изменить сообщение повышения уровня'
            )
            .addComponents(
                new ActionRowBuilder()
                    .addComponents(
                        new TextInputBuilder()
                            ...
                            .setLabel(
                                'Сообщение ({user} и {level} доступны)'
                            )
                            .setStyle(
                                TextInputStyle.Paragraph
                            )
...
async function handleXpRange(
    ...
    const modal =
        new ModalBuilder()
            ...
            .setTitle(
                'Настроить диапазон XP за сообщение'
            )
            .addComponents(
        ...
        await replyUserError(
            submitted,
            {
                type:
                    ErrorTypes.VALIDATION,
                message:
                    'Оба значения XP должны быть целыми числами от **1** до **500**.'
            }
        );
        ...
        await replyUserError(
            submitted,
            {
                type:
                    ErrorTypes.VALIDATION,
                message:
                    'Минимальное количество XP не может быть больше максимального.'
            }
        );
...
async function handleXpCooldown(
        ...
        await replyUserError(
            submitted,
            {
                type:
                    ErrorTypes.VALIDATION,
                message:
                    'Задержка должна быть целым числом от **0** до **3600** секунд.'
            }
        );
    ...
    await submitted.reply({
        embeds: [
            successEmbed(
                '✅ Задержка обновлена',
                `Задержка XP установлена на **${newCooldown} ${
                    newCooldown !== 1
                        ? 'секунд'
                        : 'секунду'
                }**.${
